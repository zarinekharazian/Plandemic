...
We started out by following the tutorial available on the [CoorNet site](http://coornet.org/tutorial01.html) to extract a list of entities engaged in rapid linksharing. This series of steps, especially calling `get_cthares`, will take a long time, as it queries the CrowdTangle API. Be patient, maybe make yourself a cup of tea (or 11). 
